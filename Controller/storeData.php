...
if (isset($_SESSION['name'])){}
  ...
  {  $name = $email = $mobile_number = $shift = $address = $password = $confirm_password = $gender  = $dob = $encrypted_password = '';}

$nameErr = $emailErr = $mobile_numberErr = $shiftErr =$addressErr = $passwordErr = $confirm_passwordErr = $genderErr  = $dobErr = '';
$flag=1;
$update="on";  
...
{  
  ...
  else 
  {
    ...
    {
      $dobErr = 'You have to be minimum 18 years old';
      $flag=0;  
      }
  }
  ...
  if ($flag==1) 
  {
    if(isset($_POST["submit"]))  
    {
      $encrypted_password = password_hash($_POST['password'], PASSWORD_BCRYPT, ["cost" => 10]);
        ...
        if(addEmpData($encrypted_password))
        {
          echo 'Employee Registration Completed';
        }
